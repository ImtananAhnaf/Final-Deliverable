            ...
            <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="course-item bg-light">
                    <div class="position-relative overflow-hidden text-center">
                        <img class="img-thmubnail" style="width: 100%;" src="assets/images/<?=$Course['image']?>"
                            alt="">
                    </div>
                </div>
            </div>
...
<df-messenger intent="WELCOME" chat-title="TrainingCompanyAgent" agent-id="86aa346f-ef4c-4fb3-95fe-b8507e942eea"
    language-code="en" chat-width="400px" chat-height="600px">
</df-messenger>